defmodule StackoverflowCloneL.Controller.Book.IndexTest do
  use StackoverflowCloneL.CommonCase
  alias Dodai.RetrieveDedicatedDataEntityListRequestQuery, as: Query
  alias Sazabi.G2gClient
  alias StackoverflowCloneL.Controller.Book.Index
  alias StackoverflowCloneL.Controller.Book.IndexRequestParams
  alias StackoverflowCloneL.TestData.BookData
