...
defmodule StackoverflowCloneL.Controller.Book.IndexRequestParams do
...
defmodule StackoverflowCloneL.Controller.Book.Index do
  ...
  alias StackoverflowCloneL.Controller.Book.{Helper, IndexRequestParams}
